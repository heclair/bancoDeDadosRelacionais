...
CREATE OR REPLACE VIEW v_depcidadehouston AS SELECT d.nome AS nome_departamento, c.nome AS nome_cidade FROM tbl_departamentos d INNER JOIN tbl_cidades c ON d.cod_cidade = c.cod_cidade WHERE nome_departamento = 'Houston';
